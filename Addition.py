...
# this is for 2x2 matrix and 3x3 matrix addition
...
def addition():
    ...
    # Write to file
    with open("Addition_Matrices.txt", "a") as f:
        f.write("Matrix A:\n")
        f.write(f"|{a1} {a2}|\n|{a3} {a4}|\n\n")
        f.write("Matrix B:\n")
        f.write(f"|{b1} {b2}|\n|{b3} {b4}|\n\n")
...
def addition_of():
    ...
    # Save to file
    current_time = time.strftime("%Y-%m-%d %H:%M:%S")
    with open("3x3_addition.txt", "a") as f:
        f.write("Matrix A:\n")
        f.write(f"|{a1} {a2} {a3}|\n|{a4} {a5} {a6}|\n|{a7} {a8} {a9}|\n\n")
        f.write("Matrix B:\n")
        f.write(f"|{b1} {b2} {b3}|\n|{b4} {b5} {b6}|\n|{b7} {b8} {b9}|\n\n")
    ...
    print(" 3x3 Addition result saved to '3x3_addition.txt'")